      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          <div className="flex overflow-x-auto gap-6 pb-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white border border-gray-200 rounded-lg p-6 min-w-[300px] flex-shrink-0">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Our experience with this service has been exceptional. The platform provided us with a seamless hiring 
                  process, from posting job openings to finding the perfect candidates. The user-friendly interface made it 
                  easy for our team to collaborate, review applications, and schedule interviews.
                </p>
              </div>
            ))}
          </div>
